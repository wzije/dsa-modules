...
Sebelum melanjutkan ke pertemuan 2, pastikan Anda dapat:
- [ ] Menjelaskan konsep algoritma dengan contoh
- [ ] Membuat fungsi Python dengan parameter dan return value
- [ ] Menggunakan list dan operasi dasarnya
- [ ] Membuat program dengan perulangan dan percabangan
- [ ] Menyelesaikan masalah sederhana dengan pendekatan algoritmik
